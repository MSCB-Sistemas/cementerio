...
CREATE TABLE `parcela` (
  ...
  `hilera` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `seccion` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `fraccion` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  `nivel` int DEFAULT NULL,
  `orientacion` varchar(100) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
